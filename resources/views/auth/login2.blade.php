				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width: 90%!important;">
							<div class="header">
								<div class="logo text-center"><a href="../"><img src="{{asset('images/logo.png')}}" alt="Klorofil Logo" style="width: 50px; height: 50px;"></a></div><h3>BeJA</h3>
								<p class="lead">SMK KP 2 MARGAHAYU</p>
							</div>
					...
					<div class="right">
						<div class="overlay" style="background-color: #F9C319; opacity: 0.9;"></div>
						<div class="content text">
							<h1 class="heading" style="font-weight: normal;">Selamat Datang Di BeJA "Administrator"</h1>
