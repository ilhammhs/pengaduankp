...
<body>
    <nav class="navbarku">
            <img src="{{asset('images/logo.png')}}" width="200" id="logo" class="logo">
            
            <a href="/login" class="right btnku">Siswa/Staff</a>
            <a href="/admin" class="right btnku">Administrator</a>
    ...
    <div class="home" id="home">
        <div class="container">
            <div class="block2">
                <h1>BeJA</h1>
                <h3>"Berani Jadi Aspirator"</h3>
                <p>Aplikasi Layanan Aspirasi dan Pengaduan <b>SMK KP 2 MARGAHAYU.</b></p>
            </div>
        </div>
    </div>
